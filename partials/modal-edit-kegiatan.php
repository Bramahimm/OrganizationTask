  ...
  <div id="modalEdit" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white rounded-lg shadow-md w-full max-w-lg p-6">
      <div class="flex justify-between items-center mb-4">
        ...
        <button onclick="window.location.href='index.php?route=jadwal-kegiatan-pengurus'" class="text-gray-600 hover:text-gray-900">
      ...
      <form method="POST" action="index.php?route=jadwal-kegiatan-pengurus">
        ...
        <div class="space-y-4">
          ...
          <input type="date" name="tanggal" value="<?= htmlspecialchars($editData['tanggal'] ?? '') ?>" class="w-full border rounded p-2" required>
