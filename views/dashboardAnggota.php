  ...
  <aside class="w-64 bg-white shadow-md">
    ...
    <nav class="p-4">
      <ul class="space-y-2">
        ...
        <li><a href="../logout.php" class="flex items-center p-2 hover:bg-gray-100 rounded text-red-600"><span class="ml-2">Logout</span></a></li>
      </ul>
    </nav>
  </aside>
      ...
      <div class="overflow-x-auto">
        <table class="w-full table-auto text-sm">
          ...
          <tbody>
            ...
            <!-- Loop tugas dinamis dari database di sini -->
          </tbody>
        </table>
      </div>
    </div>
